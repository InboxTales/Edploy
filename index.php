<?php include 'includes/header.php'; ?>
                ...
                <div class="about-content-courser owl-carousel owl-theme">
                    <div class="content-items" data-dot="<button>01</button>">
                        ...
                        <div class="content" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <p>Boost your career with Our Professional courses. Gain Practical skills and Knowledge from experienced instructors. Choose from flexible learning options to fit your needs. Advance your expertise and open new career doors today.</p>
                            <a class="default-btn" href="./professional-courses.php">Explore Courses</a>
                        </div>
                    </div>
                    <div class="content-items" data-dot="<button>02</button>">
                        ...
                        <div class="content" data-aos="fade-up" data-aos-delay="200">
                            <span>About Courses</span>
                            <h2>INTEGRATED COURSES</h2>
                            <p>Integrated courses are specially designed programs that combine undergraduate or postgraduate studies with professional qualifications. These courses streamline the educational process by allowing students to earn both an academic degree and a professional certification in a cohesive, continuous program. They are ideal for students who have a clear career path and want to gain advanced knowledge and skills efficiently.</p>
                            <a class="default-btn" href="schedule-tour.html">Explore Courses</a>
                        </div>
                    </div>
                    <div class="content-items" data-dot="<button>03</button>">
                        ...
                        <div class="content" data-aos="fade-up" data-aos-delay="200">
                            <span>About Courses</span>
                            <h2>SKILL COURSES</h2>
                            <p>Skill courses are designed to equip students and professionals with practical, industry-relevant skills that enhance their employability and career growth. Unlike traditional academic programs, skill courses focus on hands-on training, real-world applications, and immediate applicability in the workplace. These courses are ideal for individuals looking to upskill, reskill, or specialize in specific areas to stay competitive in today's dynamic job market. </p>
                            <a class="default-btn" href="schedule-tour.html">Explore Courses</a>
                        </div>
                    </div>
        ...
        <div class="features-area-2" id="features">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-md-6 pt-25">
                                        <div class="academic-item" data-aos="fade-up" data-aos-delay="100">
                                            ...
                                            <div class="content">
                                                <h4>FINANCIAL AID &LOANS</h4>
                                                <a class="btn" href="financial.php">Learn More <i class='bx bx-right-arrow-alt'></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6 col-md-6">
                                        <div class="academic-item" data-aos="fade-up" data-aos-delay="200">
                                            ...
                                            <div class="content">
                                                <h4>CAMPUS LIFE</h4>
                                                <a class="btn" href="campus-life.php">Learn More <i class='bx bx-right-arrow-alt'></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    </a>
                                    <div class="col-lg-6 col-sm-6 col-md-6 pt-25">
                                        <div class="academic-item" data-aos="fade-up" data-aos-delay="300">
                                            ...
                                            <div class="content">
                                                ...
                                                <a class="btn" href="./hostel-facilities.php">Learn More <i class='bx bx-right-arrow-alt'></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6 col-md-6">
                                        <div class="academic-item" data-aos="fade-up" data-aos-delay="400">
                                            ...
                                            <div class="content">
                                                <h4>INTERNSHIP</h4>
                                                <a class="btn" href="./internships.php">Learn More <i class='bx bx-right-arrow-alt'></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
