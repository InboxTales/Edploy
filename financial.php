            ...
            <div class="container">
                <div class="banner-spacing">
                    <div class="section-info">
                        <h2 data-aos="fade-up" data-aos-delay="100">FINANCIAL AID & LOANS</h2>
                ...
                <div class="row">
                        ...
                        <div class="academics-left">
                            <div class="ac-category">
                                <ul>
                                    ...
                                    <li><a href="financial-scholarship.php">Scholarships</a></li>
                                    <li><a href="financial-loans.php">Educational Loans</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="ac-overview">
                            <div class="pera-dec">
                                <p>At Our Edploy ecademy , we understand that pursuing higher education or
advancing your career through specialized training can be a significant
investment. Financial aid can make a world of difference in ensuring that your
goals are within reach. Whether you're a student, a professional, or a lifelong
learner, we're here to help you navigate the various financial aid options
available.</p>
                                <p>Navigating the costs of education can be challenging, but financial aid offers
essential support to help you achieve your academic and career goals. Financial
aid includes various options, such as scholarships and loans, each designed to
make education more accessible and affordable.</p>

                                <div class="univercity-life">
                                    <div class="image">
                                        <img src="assets/img/all-img/university-life.png" alt="image">
                                    </div>
